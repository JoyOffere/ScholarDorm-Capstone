-- Comprehensive Quiz Questions for Missing Courses
-- This file adds detailed quiz questions for the 4 courses that currently only have basic quiz entries
...
(VALUES
    ...
    ('Solve the system using elimination: 2x + 3y = 12, 4x - y = 2. Show your working.', 'short_answer',
     NULL, 'x = 1.5, y = 3',
     'Multiply first equation by 2: 4x + 6y = 24. Subtract second: 7y = 22, y = 3.14... Wait, let me recalculate: From 4x - y = 2, multiply by 3: 12x - 3y = 6. Add to 2x + 3y = 12: 14x = 18, x = 9/7. Actually: x = 1.5, y = 3', 
